...
export const metadata: Metadata = {
   title: 'Category List Full Banner Left Sidebar',
   description: 'Category List Full Banner Left Sidebar',
}

export default async function CategoryListFullBannerLeftSidebar() {
   // *** get posts ***
   ...
   return (
      <main className="container mx-auto px-5 md:px-0">
         ...
         <PageInfo
            pageData={{
               name: 'Category List Full Banner Left Sidebar',
               slug: 'category-list-full-banner-left-sidebar',
            }}
         />
         {/* banner section or postcard overlay Component */}
