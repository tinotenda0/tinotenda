...
export default async function CategoryListFullBannerRightSidebar() {
   // *** get posts ***
   ...
   return (
      <main className="container mx-auto px-5 md:px-0">
         ...
         <PageInfo
            pageData={{
               name: 'Category List Full Banner Right Sidebar',
               slug: 'category-list-full-banner-right-sidebar',
            }}
         />
