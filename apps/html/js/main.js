...
<div class="container mx-auto font-work p-8 mb-6">
   ...
   <nav class="hidden xl:block col-span-6">
	  <div class=" w-full flex items-center justify-center gap-10">
		   ...
		   <a href="../blog/index.html" class="link link-hover text-base text-base-content/80 hover:text-primary transition hover:duration-300">
			...
			<a href="/contact-us/index.html" class="link link-hover text-base text-base-content/80 hover:text-primary transition hover:duration-300">
			Contact
			</a>
	  </div>
   </nav>
	...
	<!--   Search section	-->
	  ...
	  <div class="flex-none">
		<div class="dropdown dropdown-end">
		  ...
		  <li onclick="setupTheme('light')" data-theme='light' class="capitalize w-full flex mb-2 rounded-md last-of-type:mb-0 justify-between items-center px-2 py-2  transition-all duration-300 cursor-pointer">
			...
			<li onclick="setupTheme('dark')" data-theme="dark" class="capitalize w-full flex mb-2 rounded-md last-of-type:mb-0 justify-between items-center px-2 py-2 transition-all duration-300 cursor-pointer">
			<span class="text-base-content flex items-center gap-2">
				Dark
			</span>
			<div class="flex flex-shrink-0 flex-wrap gap-1 h-full">
    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-12 gap-5 py-16">
            <div class="col-span-12 lg:col-span-3">
                ...
                <p class="mt-3 text-base text-base-content/70 mb-6 font-sans">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
                <div>
                    <a href="mailto:test@example.com" class="font-semibold text-base-content text-base font-sans">
                        Email : <span class="text-base-content/70 font-normal hover:text-primary hover:duration-300 transition font-sans">test@example.com</span>
                    </a>
                </div>
                <div class="mt-1">
                    <a href="tel:880123456789" class="font-semibold text-base-content text-base font-sans">
                        Phone : <span class="text-base-content/70 font-normal hover:text-primary hover:duration-300 transition font-sans">880 123 456 789</span>
                    </a>
                </div>
            </div>
            <div class="flex justify-between lg:justify-center lg:gap-20 col-span-12 lg:col-span-5">
                <div>
                    ...
                    <div class="flex flex-col gap-y-2 mt-6">
                        <a href="../" class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Home</a>
                        <a href="#" class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">About</a>
                        <a href="../blog/index.html" class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Blog</a>
                        <a href="../" class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Archived</a>
                        <a href="../author/html" class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Author</a>
                        <a href="#" class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Contact</a>
                    </div>
                </div>
                <div>
                    <h5 class="text-base-content text-lg font-semibold font-sans">Category</h5>
                    <div class="flex flex-col gap-y-2 mt-6">
                        <a href="#" class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Life style</a>
                        <a href="#" class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Technology</a>
                        <a href="#" class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Travel</a>
                        <a href="#" class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Business</a>
                        <a href="#" class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Economy</a>
                        <a href="#" class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Sports</a>
                    </div>
                </div>
            </div>
        ...
        <div class="flex flex-col gap-4 md:gap-0 md:flex-row items-center justify-between py-8 bg-base-200 border-t border-base-content/10">
            <div class="flex items-center gap-2.5">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-base-content/70 text-base font-sans">© JS Template 2023. All Rights Reserved.</p>
                </div>
            </div>
            <div class="flex items-center gap-4 text-base-content/70">
                <a href="../" class="text-base border-r border-base-content/10 pr-4 hover:text-primary transition hover:duration-300 font-sans">Terms of Use</a>
                <a href="../" class="text-base border-r border-base-content/10 pr-4 hover:text-primary transition hover:duration-300 font-sans">Privacy Policy</a>
                <a href="../" class="text-base hover:text-primary transition hover:duration-300 font-sans">Cookie Policy</a>
            </div>
        </div>
    </div>
</div>
