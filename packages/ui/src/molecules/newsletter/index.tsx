   ...
   return (
      <div className="w-full">
         <div className="bg-base-100 py-8 px-9 rounded-xl">
            <p className="text-center text-xl font-semibold text-base-content font-work">
               Weekly Newsletter
            </p>
            <p className="mt-2 text-base text-center text-base-content/60 font-work">
            ...
            <button className="btn btn-primary py-3 text-center font-medium w-full rounded-md mt-2 text-white font-work">
               Subscribe
            </button>
         </div>
      </div>
