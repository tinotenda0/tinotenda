...
export const PostOverlayMd = ({ cardData }: PostOverlayMdProps) => {
   return (
      <div className="card relative font-work max-h-[406px]">
         ...
         <div className="card-body p-2 md:p-6 absolute bottom-0 w-full z-20">
            ...
            <h3>
               <a
                  href={`/${cardData?.slug}`}
                  className="text-neutral-content line-clam-3 font-semibold text-xl md:text-2xl hover:text-primary transition hover:duration-500"
               >
                  {cardData?.title ||
